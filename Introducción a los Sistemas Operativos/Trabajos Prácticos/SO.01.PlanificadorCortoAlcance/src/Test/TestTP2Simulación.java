...
public class TestTP2Simulación {
	...
	public static void main(String[] args) {
		...
		admP3.agregarProceso("P1", 1, 8, 3, 3, Prioridad.Alta);
		admP3.agregarProceso("P2", 1, 2, 4, 3, Prioridad.Baja);
		admP3.agregarProceso("P3", 3, 2, 5, 6, Prioridad.Media);
		...
		System.out.println(admP3.mostrarAlgoritmoPrioridadSPNRoundRobin(1));
