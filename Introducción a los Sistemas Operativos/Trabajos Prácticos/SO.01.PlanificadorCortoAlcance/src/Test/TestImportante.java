...
public class TestImportante {
	...
	public static void main(String[] args) {
		...
		admProcesamiento admP = new admProcesamiento(20, 75);
...
//		System.out.println(admP.mostrarAlgoritmoFIFO().hashCode());
//		System.out.println(admP.mostrarAlgoritmoPrioridad());
		
		//*****************************************************************************
		//-Prueba numero 2 del algoritmo FIFO
		admProcesamiento admP2 = new admProcesamiento (8, 75);
		...
		System.out.println(admP2.mostrarAlgoritmoPrioridad()); // unico que anda mal
		//*****************************************************************************
		//-Prueba numero 3 del algoritmo FIFO
		admProcesamiento admP3 = new admProcesamiento (8, 75);
