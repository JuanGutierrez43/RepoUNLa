...
public class Test {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println(s1.agregarCliente("Ezequiel Leotta",40423033,"Mentruyt 1443"));
			System.out.println("********37*********"); //traigo cliente
			System.out.println(s1.traerCliente(1));
		...
		System.out.println(s1.agregarCliente("Juan Gutierrez",40125698,"Larroque 1546"));
		System.out.println("********40*********"); //traigo cliente
		System.out.println(s1.traerCliente(2));
		System.out.println("********41*********"); //elimino cliente
		System.out.println(s1.eliminarCliente(2));
		...
		try{
			...
			System.out.println(s1.agregarCarrito(f.traerFecha("15/06/1997"),s1.traerCliente(1)));
			...
			System.out.println(s1.agregarCarrito(f.traerFecha("16/06/1997"),s1.traerCliente(1)));
			System.out.println("********49*********"); //traigo carrito
			System.out.println(s1.traerCarrito(1));
			System.out.println("********50*********"); //traigo los productos para recordarlos
			System.out.println(s1.getLstProducto());
			System.out.println("********51*********"); //agrego manteca al carrito 5*30=150
			System.out.println(s1.traerCarrito(1).agregarItem(s1.traerProducto(1),5));
			System.out.println("********52*********"); //agrego leche al carrito 5*25=125
			System.out.println(s1.traerCarrito(1).agregarItem(s1.traerProducto(2),5));
			...
			System.out.println(s1.calcularTotal(s1.traerCliente(2)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
		...
		try{
			...
			System.out.println(s1.agregarCliente("Victor Ibanez",38412879,"Larroque 4789"));
			System.out.println("********58*********"); //agrego carrito de cliente 2
			System.out.println(s1.agregarCarrito(f.traerFecha("06/06/1997"),s1.traerCliente(2)));
			System.out.println("********59*********"); //agrego manteca al carrito 10*30=300
			System.out.println(s1.traerCarrito(2).agregarItem(s1.traerProducto(1),10));
			System.out.println("********60*********"); //agrego leche al carrito 10*25=250
			System.out.println(s1.traerCarrito(2).agregarItem(s1.traerProducto(2),10));
		...
		try{
			...
			System.out.println(s1.calcularTotal(f.traerFecha("15/06/1997"),f.traerFecha("18/06/1997"),s1.traerCliente(1)));
			System.out.println("********69*********"); //calculo total entre fechas de cliente 2, no hizo compras
			System.out.println(s1.calcularTotal(f.traerFecha("15/06/1997"),f.traerFecha("18/06/1997"),s1.traerCliente(2)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
		try{
			...
			System.out.println(s1.calcularTotal(f.traerFecha("15/06/1997"),f.traerFecha("18/06/1997"),s1.traerCliente(3)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
		try{
			...
			System.out.println(s1.calcularTotal(f.traerFecha("06/06/1997"),s1.traerCliente(2)));
			System.out.println("********72*********"); //calculo total de cliente 2 en fecha donde no compro
			System.out.println(s1.calcularTotal(f.traerFecha("10/06/1997"),s1.traerCliente(2)));
			System.out.println("********73*********"); //calculo total de cliente inexistente
			System.out.println(s1.calcularTotal(f.traerFecha("06/06/1997"),s1.traerCliente(3)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
		...
		try{
			...
			System.out.println(s1.calcularTotal(06,1997,s1.traerCliente(2))); 
			System.out.println("********75*********"); //calculo total de cliente 2 en fecha donde no compro
			System.out.println(s1.calcularTotal(07,1997,s1.traerCliente(2)));
			System.out.println("********76*********"); //calculo total con mes invalido
			System.out.println(s1.calcularTotal(13,1997,s1.traerCliente(2)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
		...
		try{
			...
			System.out.println(s1.calcularTotal(07,1997,s1.traerCliente(4)));
		} catch(Exception e) {
			System.out.println(e.getMessage());
			// e.printStackTrace()
		}
